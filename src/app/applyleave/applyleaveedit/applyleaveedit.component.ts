...
@Component({
  selector: 'app-applyleaveedit',
  templateUrl: './applyleaveedit.component.html',
  styleUrls: ['./applyleaveedit.component.css']
})
export class ApplyleaveeditComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.leaveForm.controls['employee_id'].setValue(this.first_name);
  ...
  onUpdate(){
    console.log("onupdated called", this.leaveForm.value)
